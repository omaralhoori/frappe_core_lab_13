...
def set_name_by_naming_series(doc):
	...
	prefix = ""
	#if frappe.get_meta(doc.doctype).add_branch_prefix == 1:
	if doc.get("company"):
		prefix = frappe.db.get_value("Company", doc.company, "abbr") + "-"
	doc.name = make_autoname(prefix + doc.naming_series + ".#####", "", doc)
