...
def generate_qrcode(ipaddress , pngname , qrpath='/public/files/covidqrcode/', http='http://', pagename="qrview"):
	site_name = cstr(frappe.local.site)
	#http://94.142.51.110:1952/qrview?usercode={{doc.customer_password+'_'+doc.name}}
	big_code = pyqrcode.create(http + ipaddress + '/' + pagename + '?usercode='+pngname, error='M')
	create_path(site_name+qrpath)
	big_code.png(site_name+qrpath+pngname, scale=6)
	return ''
